...
export default function HomePageClient({ constituencies }: { constituencies: Constituency[] }) {
    const { t } = useLanguage();
                    ...
                    <section className="text-center py-20 md:py-32">
                        <div className="container mx-auto px-4">
                            ...
                            <div className="mt-10 flex flex-col sm:flex-row justify-center items-center gap-4 sm:gap-6">
                                ...
                                >
                                    🗳 {t("Homepage.hero.buttonCheckEligibility")}
                                </Link>
